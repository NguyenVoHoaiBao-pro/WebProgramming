    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-12 mt-5 pt-5">
                <img src="<%= request.getContextPath() %>/doanweb/images/about/image copy 2.png" class="img-fluid"
                     alt="about-img">
                <img src="<%= request.getContextPath() %>/doanweb/images/about/image copy 3.png" class="img-fluid"
                     alt="about-img">
                <img src="<%= request.getContextPath() %>/doanweb/images/about/about2.png" class="img-fluid"
                     alt="about-img">
            </div>
            <div class="col-lg-6 col-md-6 col-12 mt-5 m-3 p-5">
                ...
                <img src="<%= request.getContextPath() %>/doanweb/images/about/image copy.png" class="img-fluid"
                     alt="about-img">
                <p class="py-3"><span style="color: #BC1F23">MarsStore</span> không chỉ là một cửa hàng bán gà rán;
                    chúng tôi là những người đam mê ẩm thực. Với tình yêu dành cho gà và sự tận tâm trong từng món ăn,
                    đội ngũ đầu bếp của chúng tôi đã nghiên cứu và phát triển các công thức độc quyền để mang đến cho
                    bạn những miếng gà rán giòn rụm, ngọt mềm và đầy hương vị. Chúng tôi cam kết sử dụng nguyên liệu
                    chất lượng cao nhất để đảm bảo mỗi bữa ăn đều hoàn hảo.
                    Việc gắn liền tên quán với "Sao Hỏa" ngụ ý rằng tiệm gà có phong cách khác biệt, độc đáo, hoặc có
                    thể là thực đơn đặc biệt không giống với các tiệm gà truyền thống, hàm ý rằng món gà ở đây ngon đến
                    mức khách hàng có thể cảm thấy như đang trải nghiệm một điều gì đó ngoài sức tưởng tượng.Chất Lượng
                    "Ngoài Hành Tinh"
                </p>
            </div>
        </div>
        <img src="<%= request.getContextPath() %>/doanweb/images/about/cotmocPhatTrien.png" class="img-fluid"
             alt="about-img">
    </div>
</section>
